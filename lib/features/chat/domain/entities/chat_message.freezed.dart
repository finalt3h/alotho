...
class _$ChatMessageImpl extends _ChatMessage {
  ...
  @override
  String toString() {
    return 'ChatMessage(id: $id, conversationId: $conversationId, isFromCurrentUser: $isFromCurrentUser, text: $text, imageAssetPath: $imageAssetPath, createdAt: $createdAt, deliveryStatus: $deliveryStatus, retryCount: $retryCount)';
  }
