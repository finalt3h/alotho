...
mixin _$WorkerModel {
  ...
  String get serviceCategoryId => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$WorkerModelImpl extends _WorkerModel {
  ...
  @override
  String toString() {
    return 'WorkerModel(id: $id, fullName: $fullName, age: $age, professionTitle: $professionTitle, serviceCategoryId: $serviceCategoryId, area: $area, yearsOfExperience: $yearsOfExperience, rating: $rating, completedJobs: $completedJobs, distanceInKm: $distanceInKm, priceDescription: $priceDescription, shortBio: $shortBio, avatarUrl: $avatarUrl)';
  }
